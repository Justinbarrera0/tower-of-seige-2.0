...
function draw() {
  ...
  box3.display("red", "rblack");
  box4.display("red", "black");
  box5.display("red", "black");
  box6.display("green", "black");
  box7.display("green", "black");
  box8.display("green", "black");
  box9.display("green", "black");
  box10.display("pink", "black");
  box11.display("pink", "black");
  box12.display("pink", "black");
  ...
  py4.display(rgb(110, 71, 102), "indigo")
  py5.display(rgb(110, 71, 102), "red")
  py6.display(rgb(251, 189, 76), "yellow")
  sling.display("yellow");
  stand1.display();
  stand2.display();
  ball.display("darkblue", "red");
  textSize(35);
  fill(0);
  text("Remember to have fun!", 150, 385)
